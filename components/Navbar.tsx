          ...
          <div className="flex items-center gap-5">
            {clientName ? (
              <div className="hidden md:flex items-center gap-4">
                <Link
                  href="/compte"
                  className="text-[10px] tracking-widest uppercase text-accent hover:text-primary transition-colors font-medium flex items-center gap-1.5"
                >
                  <User size={15} />
                  Bonjour, {clientName}
                </Link>
            ...
            {clientName ? (
              <>
                <Link
                  ...
                  className="text-sm tracking-[0.3em] uppercase hover:text-accent transition-colors font-medium"
                >
                  Mon Compte ({clientName})
                </Link>
                <button
                  onClick={() => { handleLogout(); setMobileOpen(false); }}
                  className="text-sm tracking-[0.3em] uppercase text-red-500 hover:text-foreground transition-colors"
                >
                  Se déconnecter
                </button>
              </>
