      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="border border-border bg-card p-6 md:p-8">
            ...
            <Link
              href="/commander"
              className="w-full mt-8 bg-primary text-background py-4 text-[10px] tracking-[0.3em] uppercase font-bold hover:bg-accent hover:text-background transition-colors duration-300 flex items-center justify-center gap-2"
            >
